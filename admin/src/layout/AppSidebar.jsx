...
const AppSidebar = () => {
  ...
  useEffect(() => {
    ...
    if (!moderator) {
      setItems([
        {
          icon: <Icon icon="ri:dashboard-line" className="text-2xl" />,
          name: "Dashboard",
          path: "/dashboard",
        },
        ...
        {
          icon: <Icon icon="ri:calendar-line" className="text-2xl" />,
        ...
        {
          icon: <Icon icon="ri:file-edit-line" className="text-2xl" />,
          name: "Site İçerik Yönetimi",
          path: "/site-content",
          subItems: [
            {
              name: "Hizmetler",
            ...
            {
              name: "Öncesi-Sonrası",
              path: "/site-content/before-after",
            },
            {
    ...
    >
      ...
      >
        <Link href="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <h1 className="text-2xl font-bold">Doctor Admin</h1>
            </>
          ) : (
