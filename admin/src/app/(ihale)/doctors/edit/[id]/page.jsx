...
export default function EditDoctor() {
    ...
    const fetchDoctor = async () => {
        try {
            ...
            if (response.data.success) {
                ...
                if (doctor.image) {
                    setCurrentImage(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}${doctor.image}`);
                }
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`/doctors/${params.id}`, formDataToSend, {
                headers: {
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            {currentImage && !preview && (
                                <div className="mb-3">
                                    <img src={currentImage} alt="Current" className="w-32 h-32 object-cover rounded-full" onError={(e) => { e.target.src = '/placeholder.webp'; }} />
                                </div>
                            )}
                            <input
                                type="file"
