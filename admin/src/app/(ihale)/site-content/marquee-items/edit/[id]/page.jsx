...
export default function EditMarqueeItem() {
    ...
    const fetchItem = async () => {
        try {
            setFetching(true);
            const response = await axios.get(`/marquee-items/${params.id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            await axios.put(`/marquee-items/${params.id}`, formData);
    ...
    return (
        <div>
            <PageBreadcrumb title="Marquee Item Düzenle" />
            <ComponentCard>
