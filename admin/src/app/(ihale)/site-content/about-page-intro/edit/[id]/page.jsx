...
export default function EditAboutPageIntro() {
    ...
    const fetchIntro = async () => {
        try {
            setFetching(true);
            const response = await axios.get(`/about-page-intro/all`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (image) {
                formDataToSend.append('about-intro', image);
            }

            await axios.put(`/about-page-intro/${params.id}`, formDataToSend, {
                headers: {
            ...
            router.push('/site-content/about-page-intro');
        } catch (error) {
    ...
    return (
        <div>
            <PageBreadcrumb title="Hakkımızda Intro Düzenle" />
            <ComponentCard>
