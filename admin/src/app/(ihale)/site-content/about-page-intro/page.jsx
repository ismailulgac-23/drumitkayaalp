...
export default function AboutPageIntro() {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete(`/about-page-intro/${id}`);
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Hakkımızda Intro" />
            <div className="space-y-6">
                <ComponentCard 
                    title="Hakkımızda Intro Yönetimi"
                    titleRightRenderer={
                        <Link href="/site-content/about-page-intro/create">
                            ...
                            renderItem={(item) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className="px-5 py-4 sm:px-6 text-start flex gap-2">
                                        <Link href={`/site-content/about-page-intro/edit/${item.id}`}>
