...
function Services() {
  ...
  return (
    <>
      <section className="services-inline2 section-padding sub-bg bord-bottom-grd bord-top-grd" style={{ paddingTop: '50px' }}>
        <div className="container ontop">
          <div className="sec-head mb-80">
            <div className="row">
              <div className="col-lg-8 offset-lg-2 text-center">
                <p className="fz-18 opacity-7">
                  Sağlığınız için kapsamlı ve bütünsel bir yaklaşım benimsiyoruz.
                  Her hasta için özel olarak hazırlanmış tedavi planları ile
